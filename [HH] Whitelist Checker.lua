...
while Enter do wait()
    pcall(function()
        if Whitelisted[game.Players.LocalPlayer.Name] then
            ...
            loadstring(game:HttpGet("https://raw.githubusercontent.com/HankRBXHelper/Hank-HUB/main/%5BHH%5D%20Hank%20HUB%20Login.txt", true))()
            Enter = false
        end
    end)
end

while Failed do wait()
    pcall(function()
